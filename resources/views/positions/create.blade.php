    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-pink-400 to-rose-400 px-8 py-6">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-white">Form Jabatan Baru</h2>
                    <p class="text-pink-100 text-sm mt-1">Tambahkan jabatan baru beserta gaji pokoknya</p>
                </div>
            </div>
        </div>

        <!-- Form Body -->
        <form action="{{ route('positions.store') }}" method="POST" class="p-8 space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input 
                        ...
                        required
                        maxlength="100"
                        class="pl-10 w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-pink-400 focus:outline-none transition-colors @error('nama_jabatan') border-red-300 @enderror"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input 
                        ...
                        min="0"
                        step="1000"
                        class="pl-12 w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-pink-400 focus:outline-none transition-colors @error('gaji_pokok') border-red-300 @enderror"
                        placeholder="5000000"
                ...
                <div class="mt-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <span class="text-sm text-green-700">
                            ...
                            <span id="preview-gaji" class="font-bold">Rp 0</span>
                        </span>
                    </div>
                </div>
            </div>
