    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-pink-400 to-rose-400 px-8 py-6">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-white">Tambah Absensi</h2>
                    <p class="text-pink-100 text-sm mt-1">Catat kehadiran pegawai</p>
                </div>
            </div>
        </div>

        <!-- Form Body -->
        <form action="{{ route('attendances.store') }}" method="POST" class="p-8 space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea name="keterangan" id="keterangan" rows="4"
                        ...
                        placeholder="Tambahkan catatan atau alasan (opsional)...">{{ old('keterangan') }}</textarea>
                    @error('keterangan')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
